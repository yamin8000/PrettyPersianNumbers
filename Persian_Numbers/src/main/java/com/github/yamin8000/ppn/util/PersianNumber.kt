...
internal object PersianNumber {
    ...
    internal val singleDigits = mapOf(
        0L to ZERO,
        1L to ONE,
        2L to TWO,
        3L to THREE,
     ...
     */
    internal val threeDigits = mapOf(
        100L to "یک$HUNDRED",
        200L to "دویست",
        300L to "سی$HUNDRED",
        400L to "$FOUR$HUNDRED",
        500L to "پان$HUNDRED",
        600L to "$SIX$HUNDRED",
        700L to "$SEVEN$HUNDRED",
        800L to "$EIGHT$HUNDRED",
    ...
    internal val bigIntegerTenPowers: Map<BigInteger, String> = mapOf(
        bigTen.pow(21) to SEXTILLION,
        bigTen.pow(24) to SEPTILLION,
        bigTen.pow(27) to OCTILLION,
        bigTen.pow(30) to NONILLION,
        bigTen.pow(33) to DECILLION,
        bigTen.pow(36) to UNDECILLION,
        bigTen.pow(39) to DUODECILLION,
        bigTen.pow(42) to TREDECILLION,
        bigTen.pow(45) to QUATTUORDECILLION,
        bigTen.pow(48) to QUINDECILLION,
        bigTen.pow(51) to SEXDECILLION,
        bigTen.pow(54) to SEPTENDECILLION,
        bigTen.pow(57) to OCTODECILLION,
        bigTen.pow(60) to NOVEMDECILLION,
